...
class Juego
{
    ...
    public void RegistrarTiro(int suma, int tiro, int dado1, int dado2)
    {
        ...
        // Calcular si el tiro es par o impar
        bool esPar = (dado1 + dado2) % 2 == 0;
        bool esParCasa = (dado1 + dado2) % 2 == 0;

        // Contar tiros pares e impares de la casa
        if (esParCasa)
        {
            TirosParesCasa++;
        }
        ...
        // Contar tiros iguales de la casa
        if (dado1 == dado2)
        {
            TiroIgualCasa++;
        }
        ...
        else
        {
            ...
            else if (PuntajeJugador == 0)
            {
                ...
                // Contar tiros pares e impares del jugador
                if (esPar)
                {
                    TirosPares++;
                }
                ...
                // Contar tiros iguales del jugador
                if (dado1 == dado2)
                {
                    TiroIgualJugador++;
                }
